...
class TestCase14(unittest.TestCase):
    ...
    @pytest.mark.test_case_14
    @file_data("../testdata/data.json")
    def test_case14(self, name, email, password, dayinfo, monthinfo, yearinfo, fnames, lnames, compdet, address1, address2, countryname, state, city, zipcode, mobilenum, card_name, card_num, cvc, exp_month, exp_year):
        # Launch browser
