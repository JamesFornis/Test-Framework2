...
class TestCase24(unittest.TestCase):
    ...
    @pytest.mark.test_case_24
    @file_data("../testdata/data.json")
    def test_case24(self, name, email, password, dayinfo, monthinfo, yearinfo, fnames, lnames, compdet, address1, address2, countryname, state, city, zipcode, mobilenum, card_name, card_num, cvc, exp_month, exp_year):
        # Launch browser
        ...
        go_to_cart_page.click_register_login_btn()

        # Fill all details in Signup and create account
        self.sp.search_input(name,
                             email)
        ...
        self.logged_user.click_download_invoice_btn()

        # Click 'Continue' button
        self.logged_user.click_continue_invoice_btn()
